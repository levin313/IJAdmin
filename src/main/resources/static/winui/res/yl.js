window.YL = {
  info: {
    softwareName: 'IJAdmin',
    version: "1.0.0",
    iconBtnStart: 'yoast',
    author: 'Levin',
    contactInformation: 'Levin@qq.com',
    officialWebsite: 'https://www.levin.com',
    copyrightDetail: 'All Rightes Reserved !',
    otherStatements: '',
  },
  data: {},
  lang: function (key) {
  ...
  _baseData: function () {
    return {
      ...
      configs: {
        ...
        sound: false,//开启声音
        wallpaper: '../winui/res/img/wallpapers/bg1.jpg',
...
YL.util.onloadSafe(function () {
  YL.util.loadScript('../winui/configs.js', function () {
    ...
    YL.util.loadContentFromUrl('../winui/langs/' + YL.static.lang + '.json', 'GET', function (err, text) {
      if (!err) {
